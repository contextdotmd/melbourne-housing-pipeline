...
--
-- Keyed on suburb AND address because address alone is not unique — "5 Charles St" occurs in
-- seven suburbs, and merging them would splice unrelated sale histories together.
--
-- No rooms or type here: both differ between outcomes for the same dwelling (110 and 71
